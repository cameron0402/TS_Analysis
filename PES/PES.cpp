...
const uint8_t PROGRAM_STREAM_MAP = 0xBC;
const uint8_t PADDING_STREAM = 0xBE;
const uint8_t PRIVATE_STREAM_2 = 0xBF;
const uint8_t ECM_STREAM = 0xF0;
const uint8_t EMM_STREAM = 0xF1;
const uint8_t PROGRAM_STREAM_DIRECTORY = 0xFF;
const uint8_t DSMCC_STREAM = 0xF2;
const uint8_t E_STREAM = 0xF8;
